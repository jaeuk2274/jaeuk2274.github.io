...
이후
순열 알고리즘에 대해 한번 공부를 하고, 구현하고 다시 진행을 하니, 수월하게 진행하였다.                
...
이 케이스에서는 모든 경우의 수니까 if 조건을 빼 주었다.
~~~java
...
풀고 나서 보니 가장 인기있는 풀이와 유사하게 풀었더라..
순열 공부는 엔지니어대한민국 님의 유튜브를 참고하여 공부하였다. 이분 되게 설명도 잘하시고 좋은 유투브 같다! 
